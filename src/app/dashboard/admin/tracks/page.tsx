...
export default function AdminCoursesPage() {
  ...
  const handleApprove = async (id: string) => {
    try {
      const res = await fetch(`/api/admin/tracks/${id}/approve`, {
        method: "PATCH",
      ...
      alert("An error occurred while approving the track.");
    }
  };
  ...
  const handleUnpublish = async (id: string) => {
    try {
      ...
      if (res.ok) {
        ...
        alert("Failed to unpublish track.");
      }
    } catch (err) {
      console.error("Failed to unpublish track", err);
      alert("An error occurred while unpublishing the track.");
    }
  };
