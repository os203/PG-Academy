...
export async function POST(
  ...
  try {
    const authResult = await getAuthorizedLesson(courseId, moduleId, lessonId);
    ...
    const originalDir = path.join(originalsRoot, courseId, moduleId, lessonId);
    const hlsOutputDir = path.join(hlsRoot, courseId, moduleId, lessonId);
