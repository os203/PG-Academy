...
export default function EditCourseDetailsModal({
  courseId,
  onClose,
  onSuccess,
}: EditCourseDetailsModalProps) {
    ...
    const fetchCourse = async () => {
      try {
        ...
        if (res.ok) {
          ...
          setLevel(data.level || "All Levels");
          setThumbnail(data.thumbnail || "");
          setPreviewVideoUrl(data.previewVideoUrl || "");
          setLearningObjectives(parseJsonArray(data.learningObjectives));
          setRequirements(parseJsonArray(data.requirements));
          setTargetAudience(parseJsonArray(data.targetAudience));

          // Tags: parse JSON array into comma string
          try {
            ...
            <form onSubmit={handleSave} className="space-y-4 max-h-[60vh] overflow-y-auto pr-1">
              ...
              {activeTab === "basic" && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea required value={description} onChange={(e) => setDescription(e.target.value)} className={`${inputCls} min-h-[100px]`} placeholder="Full course description..." />
                  </div>
              ...
              {activeTab === "details" && (
                <div className="space-y-6">
                  ...
                  {renderDynamicList("Who This Course Is For", targetAudience, setTargetAudience, "e.g., Business Professionals who want to analyze data")}
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className={inputCls}
                    />
                    <p className="text-xs text-muted-foreground">YouTube or direct video URL for the course preview</p>
                  </div>
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-border mt-4">
                ...
                <Button type="submit" className="bg-brand-primary text-white hover:bg-brand-primary/90" disabled={isSubmitting}>
