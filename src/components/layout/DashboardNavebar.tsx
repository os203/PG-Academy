...
export default function DashboardNavbar() {
    ...
    return (
        <div className="flex items-center justify-between bg-background relative p-4 w-full h-18">
            <div className="hidden md:flex items-center gap-3 px-2 py-1 text-xs rounded-full ring-[1.5px] ring-gray-700">
                <Search size={21} />
                <input type="text" className="w-[200px] p-2 bg-transparent"  placeholder="search...." />
            </div>
